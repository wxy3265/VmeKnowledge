...
public class KnowledgeEditor extends WebView {
    ...
    public KnowledgeEditor(Context context) {
        this(context, null);
    }

    public KnowledgeEditor(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public KnowledgeEditor(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setFontSize(int fontSize) {
        if (fontSize > 7 || fontSize < 1) {
            Log.e("KnowledgeEditor", "Font size should have a value between 1-7");
        }
    ...
    /**
     * {@link KnowledgeEditor#insertImage(String, String)} will show the original size of the image.
