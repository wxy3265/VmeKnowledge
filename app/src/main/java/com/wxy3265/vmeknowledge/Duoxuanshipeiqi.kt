...
class MutilSelectAdapter(val dataList:MutableList<String>):RecyclerView.Adapter<MutilSelectAdapter.MyViewHolder>() {
    ...
    inner class MyViewHolder(itemView:View):RecyclerView.ViewHolder(itemView){
        var tvContent: TextView =itemView.findViewById<TextView>(R.id.MainCardRecyclerview)
        var ivSelect: ImageView = itemView.findViewById<ImageView>(R.id.MainCardRecyclerview)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view =LayoutInflater.from(parent.context).inflate(R.layout.activity_duoxuan,parent,false)
