...
import com.wxy3265.vmeknowledge.MutilSelectAdapter.Companion.TAG
import kotlinx.android.synthetic.main.activity_main.*

//abstract class Duoxuan : AppCompatActivity(){
...
//        setContentView(R.layout.activity_duoxuan)
        ...
        class MutilSelectActivity : AppCompatActivity() {
            ...
            override fun onCreate(savedInstanceState: Bundle?) {
                ...
                MainCardRecyclerview.setOnLongClickListener {
            ...
            private fun initRecyclerView(){
                ...
                MainCardRecyclerview.layoutManager = LinearLayoutManager(this)
                MainCardRecyclerview.adapter = mutilSelectAdapter
